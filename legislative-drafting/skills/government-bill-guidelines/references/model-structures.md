...
PERUSTELUT
  1 Asian tausta ja valmistelu
    1.1 Tausta
      - Kotimainen tausta
      - EU-säädöksen / sopimuksen tausta
    1.2 Valmistelu
      - Kotimainen valmistelu
      - EU:n / sopimuksen valmistelu
  2 EU-säädöksen / sopimuksen tavoitteet ja sisältö (jos relevantti)
  3 Nykytila ja sen arviointi
  4 Ehdotukset ja niiden vaikutukset
    4.1 Keskeiset ehdotukset
    4.2 Pääasialliset vaikutukset
  5 Muut toteuttamisvaihtoehdot
    5.1 Vaihtoehdot
    5.2 Muiden maiden/jäsenvaltioiden ratkaisut
  6 Lausuntopalaute
  7 Säännöskohtaiset perustelut
  8 Lakia alemman asteinen sääntely
  9 Voimaantulo
...
PERUSTELUT
  1 Asian tausta ja valmistelu
    1.1 Tausta
      - Aiemman esityksen tausta
      - Uuden täydennyksen tarve
    1.2 Valmistelu
      - Valmistelun kulku
      - Osallistuneet tahot
  2 Nykytila ja sen arviointi
    - Aiemman lain vaikutukset
    - Ilmaantuneet puutteet
  3 Tavoitteet
  4 Ehdotukset ja niiden vaikutukset
    4.1 Keskeiset ehdotukset
    4.2 Pääasialliset vaikutukset
  ...
  10 Toimeenpano ja seuranta
  11 Suhde muihin esityksiin
    11.1 Suhde aiempaan esitykseen
