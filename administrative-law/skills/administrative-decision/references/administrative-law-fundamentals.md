...
säädösnumerot `juristi:oikeustutkimus`-skillillä (oik.ai/Finlex) ennen viittausta.**
...
- Hae relevantti oikeuskäytäntö `oikeustutkimus`-skillillä (esim. court "Korkein hallinto-oikeus", "Hallinto-oikeudet").
