...
> lahjavero kuuluvat `taxation`-plugariin. Katso [`AGENTS.md`](AGENTS.md).
...
- **`taxation`-plugari** – perintö-, lahja- ja varainsiirtovero lasketaan siellä,
  ei tässä.
- **`real-estate-and-housing`-plugari** – asunnon ja kiinteistön siirrot
